  ...
  return (
    ...
    >
      <Box sx={style.Box}>
        ...
        <Dialog className="non-dragable" open={open} onClose={handleClose} onKeyPress={handleKeyPress}>
          <DialogTitle>Key Press</DialogTitle>
          <DialogContent>
            <DialogContentText>Please press any key</DialogContentText>
          </DialogContent>
          <DialogActions>
